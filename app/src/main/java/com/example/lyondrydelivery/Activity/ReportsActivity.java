...
import com.example.lyondrydelivery.Adapter.Pickup_Date_Range;
...
public class ReportsActivity extends AppCompatActivity {
    ...
    private void Tablayout(){
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Pickup Date Range"));
        tabLayout.addTab(tabLayout.newTab().setText("Delivery Date Range"));
        //  tabLayout.addTab(tabLayout.newTab().setText("Purchase offer"));
        tabLayout.setTabGravity(TabLayout.GRAVITY_FILL);

        final Pickup_Date_Range adapter = new Pickup_Date_Range(this,getSupportFragmentManager(), tabLayout.getTabCount());
