...
import com.example.lyondrydelivery.Adapter.Delivery_Tab_Adapter;
...
public class DeliveryActivity extends AppCompatActivity {
    ...
    private void Tablayout(){
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Delivery Pending"));
        tabLayout.addTab(tabLayout.newTab().setText("Delivery Completed"));
        //  tabLayout.addTab(tabLayout.newTab().setText("Purchase offer"));
        tabLayout.setTabGravity(TabLayout.GRAVITY_FILL);

        final Delivery_Tab_Adapter adapter = new Delivery_Tab_Adapter(this,getSupportFragmentManager(), tabLayout.getTabCount());
